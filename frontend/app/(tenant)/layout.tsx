...
export default function TenantLayout({ children }: { children: React.ReactNode }) {
  ...
  const navLinks = [
    ...
    { name: 'My Rental', href: '/properties', icon: HomeIcon },
  ...
  const getPageTitle = () => {
    if (pathname.includes('/properties')) return 'My rental space';
    if (pathname.includes('/billing')) return 'Payments and dues';
    if (pathname.includes('/community')) return 'Community and support';
    if (pathname.includes('/profile')) return 'Tenant profile';
